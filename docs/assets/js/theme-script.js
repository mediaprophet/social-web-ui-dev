                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-singleLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/horizontal-single.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/without-header.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontal-sidemenuLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/menu-aside.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="stackedLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/stacked.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="modernLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/modern.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="transparentLayout">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/transparent.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderedCard">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/bordered.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="borderlessCard">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/borderless.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="shadowCard">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/shadow.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="compactSize">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/compact.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-span-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="hoverviewSize">
                                        <span class="block mb-2 layout-img">
                                            <img src="/src/assets/img/theme/hoverview.svg" alt="img">
                                        </span>                                    
                         ...
                         <div class="flex items-center">
                            <div class="theme-topbarbg me-3 mb-2">
                                ...
                                <label for="pattern1" class="block rounded">
                                    <img src="/src/assets/img/theme/pattern-01.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-topbarbg me-3 mb-2">
                                <input type="radio" name="topbarbg" id="pattern2" value="pattern2">
                                <label for="pattern2" class="block rounded">
                                    <img src="/src/assets/img/theme/pattern-02.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-topbarbg me-3 mb-2">
                                <input type="radio" name="topbarbg" id="pattern3" value="pattern3">
                                <label for="pattern3" class="block rounded">
                                    <img src="/src/assets/img/theme/pattern-03.svg" alt="img" class="rounded">
                                </label>
                            </div>
                        </div>
